...
public class PrevalentSystemGuard<P> implements TransactionSubscriber {
	...
	private boolean _guaranteeDeserializeThenExecute;
	...
	public void guaranteeDeserializeThenExecute(){
		_guaranteeDeserializeThenExecute=true;
	}
	...
	public void receive(TransactionTimestamp transactionTimestamp) {
		...
		synchronized (this) {
			...
			try {
				...
				capsule.executeOn(_prevalentSystem, executionTime, _journalSerializer, _guaranteeDeserializeThenExecute);				
