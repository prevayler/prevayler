 ...
 */
public abstract class AbstractPublisher<P> implements TransactionPublisher<P> {
  ...
  protected synchronized void notifySubscribers(TransactionTimestamp<P> transactionTimestamp) {
