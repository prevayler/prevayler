...
public abstract class JournalDiskSyncStrategy {
   ...
   */
  private final static class Always extends JournalDiskSyncStrategy {
    @Override
    /**
     * @return true
     */
   ...
   */
  private final static class Never extends JournalDiskSyncStrategy {
    @Override
    /**
     * @return false
     */
   ...
   */
  private final static class SometimesSingleTrigger extends JournalDiskSyncStrategy {
  ...
  public final static JournalDiskSyncStrategy ALWAYS = new Always();
  public final static JournalDiskSyncStrategy NEVER = new Never();
  public final static JournalDiskSyncStrategy SOMETIMES_SINGLE = new SometimesSingleTrigger();
