 ...
 * <br>
 * <br>IMPORTANT: Transaction objects CANNOT reference business objects directly. Instead, you must search for the business objects you need given the <code>prevalentSystem</code>. See org.prevayler.demos for usage examples.
 * <br>
