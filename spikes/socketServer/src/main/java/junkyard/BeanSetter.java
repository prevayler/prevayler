 ...
 * @author djo
 */
public abstract class BeanSetter<P, R, X> extends RemoteTransaction<P, R> {

  private static final long serialVersionUID = 8234726127210608176L;
   ...
   */
  protected abstract X lookup(P prevalentSystem) throws Exception;
