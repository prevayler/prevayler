 ...
 * @author DaveO
 */
public abstract class RemoteTransaction<P, R> implements Transaction<P>, TransactionWithQuery<P, R>, IRemoteTransaction {

  private static final long serialVersionUID = 6981598749107991872L;
  ...
  public abstract R executeAndQuery(P prevalentSystem, Date timestamp) throws Exception;

  public void executeOn(P prevalentSystem, Date timestamp) {
    try {
