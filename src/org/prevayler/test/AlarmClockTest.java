...
public class AlarmClockTest {
	...
	static private AlarmClockPuppet clockPuppet = new AlarmClockPuppet(0);
	...
	static private void crashRecover() throws Exception {
		out("CrashRecovery.");
		clockPuppet = new AlarmClockPuppet(clockPuppet.currentTimeMillis());   //A new one is created because a paused clock is needed.
		prevayler = new SnapshotPrevayler(new AbstractPrevalentSystem() {}, prevalenceBase(), clockPuppet);
		clockPuppet = (AlarmClockPuppet)system().clock();   //It might have been recovered from a snapshot.
	}
	...
	static private void setTime(long newTime) throws Exception {
		...
		clockPuppet.currentTimeMillis(newTime);
