...
public class PrevaylerFactory {
	...
	public void configureJournalSerializer(PLSerializer serializer) {
		configureJournalSerializer("pljournal", serializer);
	}
	...
	public void configureSnapshotSerializer(PLSerializer serializer) {
		configureSnapshotSerializer("plsnapshot", serializer);
	}
