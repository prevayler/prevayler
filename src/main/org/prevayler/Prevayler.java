...
public interface Prevayler<S> {
     ...
     */
    @Deprecated public S prevalentSystem();
     ...
     * @see PrevaylerFactory
     */
    @SuppressWarnings("deprecation") @Deprecated public void execute(Transaction<S> transaction);
     ...
     */
    @SuppressWarnings("deprecation") @Deprecated public <R, E extends Exception> R execute(Query<S, R, E> sensitiveQuery) throws E;
     ...
     * @see PrevaylerFactory
     */
    @SuppressWarnings("deprecation") @Deprecated public <R, E extends Exception> R execute(TransactionWithQuery<S, R, E> transactionWithQuery) throws E;
     ...
     */
    @SuppressWarnings("deprecation") @Deprecated public <R> R execute(SureTransactionWithQuery<S, R> sureTransactionWithQuery);
