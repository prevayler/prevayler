 ...
 * @see Transaction
 */
@SuppressWarnings("deprecation") @Deprecated public interface TransactionWithQuery<S, R, E extends Exception> {
     ...
     */
    public R executeAndQuery(S prevalentSystem, Date executionTime) throws E;
