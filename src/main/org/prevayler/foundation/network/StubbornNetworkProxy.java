...
/**
 * Stubborn Network Proxies are bound to each Service instance in a Prevayler
 * providing Server services for Replication.
 * 
 * This allows the binding to be dynamically connected to a Client replicator,
 * thereby facilitating reconnection after failure.
 * 
 * A failed receive causes the proxy to capture the thread until the replication
 * client (network) reconnects.
 * 
