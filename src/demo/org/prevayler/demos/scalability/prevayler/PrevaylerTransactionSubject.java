...
public class PrevaylerTransactionSubject extends PrevaylerScalabilitySubject<TransactionSystem, TransactionConnection> {
    ...
    @SuppressWarnings("unchecked") private Serializer<Transaction> createJournalSerializer() throws InstantiationException, IllegalAccessException, ClassNotFoundException {
        return (Serializer<Transaction>) Class.forName(_journalSerializer).newInstance();
    }
