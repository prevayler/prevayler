...
public class FileLockerTest extends FileIOTest {
    ...
    public void testFileLock() throws Exception {
        ...
        // We can acquire in this JVM after other JVM exited without explicitly
        // releasing...
    ...
    private void runProcess(File lockFile, String expectedOutput) throws IOException, InterruptedException {
        String[] command = { "java", "-classpath", System.getProperty("java.class.path"), LockingMain.class.getName(), lockFile.getCanonicalPath() };
    ...
    public static class LockingMain {
        public static void main(String[] args) {
            ...
            try {
                ...
                // But don't release, to prove that the lock is released when
                // the process exits.
            } catch (IOException e) {
