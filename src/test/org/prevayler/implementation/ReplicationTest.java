...
public class ReplicationTest extends FileIOTest {
    ...
    private void networkCrash() {
        // TODO NETWORK_MOCK.crash(); Implement a FaultTolerantNetwork so
        // Prevayler doesn't have to worry about it. (!!!!)
    }
    ...
    /*
     * //TODO Test replication chaining. public void testChaining() throws
     * Exception { serverCrashRecover(2); clientWithServerCrashRecover(2, 3);
     * clientCrashRecover(3); clientAppend("a", "a"); clientAppend("b", "ab");
     * serverAppend("c", "abc"); }
     */
