...
public class PrevaylerTransactionSubject extends PrevaylerScalabilitySubject {
	...
	public PrevaylerTransactionSubject(String logDirectory) throws java.io.IOException, ClassNotFoundException {
		...
		prevayler = PrevaylerFactory.createPrevayler(new TransactionSystem(), logDirectory);  //No snapshot is generated by the test so the snapshot directory can be the same as the first log directory.
	}
